			...
			<div class="card">
				...
				<div class="card-body">
					<form wire:submit.prevent="store">
						...
						<input id="gambar" type="file" class="form-control @error('gambar') is-invalid @enderror" wire:model="gambar" value="{{old('gambar')}}" required autocomplete="gambar" autofocus>
